...
<!-- ANCHOR: A-SK-4edcd592 L2 -->
**⚠️ 大运/小运星为 Rahu/Ketu 时：正面/负面/判定列改用 p1_p12「Dasha速查表节点专用正负面条件子表」（house_framework 六条对节点不可计算）；"大运星P1"列填"—"、"尊贵度"列填定位星状态。**
